 ...
 * 
 * Data source sekarang hanya dari parquet lokal yang disimpan di public/data.
 */
...
// Parquet lokal yang dipakai aplikasi
const LOCAL_PARQUET_URL = '/data/peta_murid.parquet';
export const PARQUET_URL = LOCAL_PARQUET_URL;

// Alias tetap disediakan agar file lain tidak perlu diubah banyak
