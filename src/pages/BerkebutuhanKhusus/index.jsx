...
export const BerkebutuhanKhusus = ({ restartKey = 0, onRestart = () => {} }) => {
  ...
  return (
    ...
    >
      <DashboardHeader title="Dashboard Berkebutuhan Khusus" onRestart={onRestart} />
      ...
      >
        ...
        >
          <iframe
            key={restartKey}
            src="https://datastudio.google.com/embed/reporting/6481b956-06ca-410a-ae4e-ed8d373cc994/page/p_pfepzen52d"
            frameBorder="0"
            allowFullScreen
